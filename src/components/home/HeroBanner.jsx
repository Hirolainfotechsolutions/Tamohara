...
function HeroBanner({ hero }) {
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_48%_35%,var(--color-white-glow),transparent_28%),linear-gradient(180deg,var(--color-black-soft)_0%,var(--color-black-medium)_42%,var(--color-overlay-strong)_100%)]" />
