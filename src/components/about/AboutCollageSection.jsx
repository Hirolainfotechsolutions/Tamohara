  ...
  return (
    <section className="app-section overflow-hidden px-4 py-16 sm:px-6 lg:py-24">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="heading-display text-[clamp(42px,5vw,70px)] font-semibold leading-[1.02]">
          {collage.title}
        </h2>
      ...
      <div className="mx-[calc(50%-50vw)] mt-14 grid w-screen overflow-hidden md:grid-cols-4 md:grid-rows-[320px_320px]">
        <img
          className="h-[340px] w-full object-cover md:col-span-2 md:h-full"
