    ...
    <section className="app-section px-4 py-16 sm:px-6 lg:py-24">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.9fr_1fr] lg:gap-20">
        <div className="overflow-hidden rounded-[var(--radius-app)] shadow-[var(--shadow-soft)]">
          <img className="h-[520px] w-full object-cover" src={story.image} alt={story.imageAlt} />
        </div>

        <div>
          <p className="section-eyebrow mb-5">{story.eyebrow}</p>
          <h2 className="heading-display max-w-[620px] text-[clamp(42px,5vw,68px)] font-semibold leading-[1.02]">
            {story.title}
          </h2>
