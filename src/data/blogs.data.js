  ...
  posts: [
    {
      ...
      image: bannerImage,
      imageAlt: 'Tamohara Resort pool and mountain view',
      body: [
        'Sakleshpur rewards the guest who refuses to rush. At Tamohara Resort, the weekend can begin with quiet poolside light, South Indian breakfast, and the kind of mountain air that makes even ordinary mornings feel ceremonial.',
    ...
    },
    {
      ...
      image: trailImage,
      imageAlt: 'Forest bridge trail near Tamohara Resort',
      body: [
    ...
    },
    {
      ...
      excerpt:
        'Breakfast, lunch, dinner, and hi-tea are part of the Tamohara rhythm, giving groups more time to relax and less time to plan.',
      image: diningImage,
    ...
    },
    {
      ...
      image: estateImage,
      imageAlt: 'Estate path around Tamohara Resort',
      body: [
    ...
    },
    {
      ...
      image: roomImage,
      imageAlt: 'Sharing room at Tamohara Resort',
      body: [
        'Tamohara Resort offers rooms for different group sizes, from 2 sharing to 12 sharing. The right choice depends less on the label and more on how your group likes to spend time.',
